<template>
  <button @click="goToArticlePage()"
    class="m-2 flex-1 rounded-lg overflow-hidden bg-white"
  ...
  >
    ...
    <div class="pt-2 px-4 pb-4 flex items-center gap-6 text-xs text-blue-400 text-left">
      <img src="@/assets/logo/logo-small.png" class="w-7 h-7 object-contain">
